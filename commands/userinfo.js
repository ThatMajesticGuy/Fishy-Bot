...
const status = {
 ...
 if (!game) {
  ...
  let user2;
  if (message.author.id === "262410813254402048" || user.id === "262410813254402048") user2 = "Owner Of The Bot!";
  if (message.author.id === "262749663172493312" || user.id === "262749663172493312") user2 = "Owner Of The Server!";
  var authors = ["262410813254402048", "262749663172493312"]
  ...
  if (member.user.bot === true) botuser = 'Yes'
	...
	.setTitle(`__Userinfo On The ${user2}__ :prince:`)
  .setColor("#ffd700")
